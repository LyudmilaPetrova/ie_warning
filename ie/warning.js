...
(function() {
	...
	var msg3 = "Нажмите на значок, чтобы попасть на страницу загрузки.";
	var closemsg = "Закрыть";
	...
	function e(str) {
		var cookie = getCookie('ie_warning');
		if (cookie)
			return;
		...
		function close() {
			...
			_body.style.overflow = _overflow;
			setCookie('ie_warning', true);
		}
		var _body = document.getElementsByTagName('body')[0];
		var _overflow = _body.style.overflow;
		...
		_dd.style.fontSize = "13px";
		_dd.style.zIndex = 100001;
		_dd.style.textAlign = 'left';
		...
		var _cl = document.getElementById('_c');
		_cl.style.position = "absolute";
		_cl.style.top = "5px";
		_cl.style.right = "10px";
		_cl.href = "javascript:void(0);";
		_cl.innerHTML = closemsg;
		_cl.onclick = close;
